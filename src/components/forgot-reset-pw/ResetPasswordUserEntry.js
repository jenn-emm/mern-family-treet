        ...
        <div className="login-register-password-bg">
          <div className="container">
            <form onSubmit={submitHandler} className="login-register-password-user-entry">
              <h1 className="login-register-password-header">Reset Password</h1>
                ...
                <div className="form-group">
                  <label className="entry">Confirm Password</label>
                  ...
                  {submitted && <p className="confirm-rp-msg">Your password has been reset.<a className="login-register-link"> Login</a></p>}
                </div>
